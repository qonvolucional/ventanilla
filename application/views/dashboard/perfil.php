    		...
    		<div class="col col-xs-12">
    			<div class="box box-warning">
    				<div class="box-header image">
    					<img src="<?php echo base_url(); ?>assets/template/img/avatar2.png" class="img-circle img-thumbnail image-perfil" alt="User Image">
    				</div>
    				...
    				<form role="form">
    					...
    					<div class="box-body">
    						...
    						<div class="row">
								...
								<div class="form-group col col-xs-4">
									<label for="nueva-clase">Nueva Contraseña</label>
